  ...
  return (
    <div className="mx-auto flex w-full flex-1 flex-col gap-8">
      ...
      <section aria-labelledby="smart-match-heading">
        <h2 id="smart-match-heading" className="sr-only">
          AI Smart Coach Matching
        </h2>
        <SmartMatchWidget />
      </section>

      {/* Traditional Search + Filters */}
      <section aria-labelledby="traditional-search-heading">
        <h2 id="traditional-search-heading" className="text-wial-navy mb-4 text-xl font-bold">
          Browse Directory
        </h2>
